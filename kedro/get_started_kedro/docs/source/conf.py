...
# get_started_kedro documentation build
...
from get_started_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "get_started_kedro"
author = "QuantumBlack"
...
htmlhelp_basename = "get_started_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "get_started_kedro.tex",
        "get_started_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "get_started_kedro",
        "Project get_started_kedro codebase.",
        "Data-Science",
    )
]
